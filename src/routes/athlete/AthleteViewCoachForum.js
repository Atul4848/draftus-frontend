...
function AthleteViewCoachForum() {
    ...
    <div className="newContnainer">
      <div className="athlete__home">
        <Row gutter={[10, 10]}>
          ...
          {forum.athleteLoadMoreURL != null ? (
            <div className="loadmore">
              <Button
                className="ant-btn ant-btn btn__profile1"
                onClick={() =>
                  dispatch(
                    loadMoreCoachForumByAthlete(forum.athleteLoadMoreURL)
                  )
                }
              >
                Load More
...
export default AthleteViewCoachForum;
